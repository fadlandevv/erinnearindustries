...
const PRODUCTS = [
  ...
  },
  {
    ...
    name: 'Amplop',
    sub: 'Packaging',
    desc: 'Packaging berlogo untuk produkmu',
  ...
  },
  {
    ...
    name: 'Coach',
    sub: 'Jacket',
    desc: 'Jaket tipis elegan, sablon atau bordir',
      ...
      <section className="custom-pick-section">
        <div className="custom-pick-inner">
          <div className="custom-pick-grid">
            {PRODUCTS.map(p => (
              <Link key={p.id} href={p.href} className="custom-pick-card" style={{ background: p.bg }}>
                <div className="custom-pick-card-top">
                  <span className="custom-pick-tag">Custom</span>
                  <div className="custom-pick-circle">{p.icon}</div>
                </div>
                <div className="custom-pick-card-bot">
                  <div>
                    <p className="custom-pick-sub">{p.sub}</p>
